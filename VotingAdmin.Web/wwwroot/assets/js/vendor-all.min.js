!(function(e, t) {
    ...
    function R(e, t, n) {
        ...
        return (
            ...
            ("" !== (a = n.getPropertyValue(t) || n[t]) ||
                ...
                (a = xe.style(e, t)), !ve.pixelBoxStyles() &&
                lt.test(a) &&
                ut.test(t) &&
                ((r = s.width),
                    (o = s.minWidth),
    ...
    function V(e, t, n) {
        var r,
            ...
            c = s.promise({
                elem: e,
                props: xe.extend({}, t),
                opts: xe.extend(!0, { specialEasing: {}, easing: xe.easing._default },
                    n
                ),
    ...
    function oe(e, t, n, r) {
        ...
        for (i = u.shift(); i;)
            if (
                (e.responseFields[i] && (n[e.responseFields[i]] = t), !l && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)),
                    (l = i),
                    (i = u.shift()))
            )
                if ("*" === i) i = l;
                ...
                return r !== H && 9 === r.nodeType && r.documentElement ?
                    ((H = r),
                        ...
                        (w.getById = o(function(e) {
                            return (
                                (j.appendChild(e).id = Y), !H.getElementsByName || !H.getElementsByName(Y).length
                            );
                        })),
                        w.getById ?
                                ...
                                if (void 0 !== t.getElementById && O) {
                                    ...
                                    if (i) {
                                        if ((n = i.getAttributeNode("id")) && n.value === e)
                                            return [i];
                                        for (o = t.getElementsByName(e), r = 0;
                                            (i = o[r++]);)
                                            if ((n = i.getAttributeNode("id")) && n.value === e)
                                                return [i];
                                    }
            ...
            (L = t.select =
                function(e, t, n, r) {
                    ...
                    if (((n = n || []), 1 === p.length)) {
                        ...
                        for (
                            o = fe.needsContext.test(e) ? 0 : i.length; o-- && ((a = i[o]), !x.relative[(s = a.type)]);
                    ...
                    return (
                        (u || C(e, p))(
                            r,
                            t, !O,
                            n, !t || (ge.test(e) && c(t.parentNode)) || t
                        ),
                        n
                    );
                }),
    ...
    xe.fn.extend({
        ...
        is: function(e) {
            return !!a(
                this,
                "string" == typeof e && Le.test(e) ? xe(e) : e || [], !1
            ).length;
        },
    });
    var De,
    ...
    (xe.event = {
        ...
        dispatch: function(e) {
            ...
            if (
                ((s.delegateTarget = this), !u.preDispatch || !1 !== u.preDispatch.call(this, s))
            ) {
                for (
    ...
    xe.each({
        ...
        xe.fn.extend({
            ...
            off: function(e, t, n) {
                ...
                return (
                    (!1 !== t && "function" != typeof t) || ((n = t), (t = void 0)), !1 === n && (n = C),
                    this.each(function() {
    ...
    xe.extend({
        ...
        xe.each({ margin: "", padding: "", border: "Width" }, function(e, t) {
            (xe.cssHooks[e + t] = {
                expand: function(n) {
                    for (
                        var r = 0, o = {}, i = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++
                    )
        ...
        xe.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            var n, r, o = e.options, i = xe.makeArray(t), a = o.length; a--;
            ...
            trigger: function(t, n, r, o) {
                ...
                if (
                    ...
                    if (!o && !f.noBubble && !be(r)) {
                        for (
                            l = f.delegateType || h, Lt.test(l + h) || (a = a.parentNode); a; a = a.parentNode
                        )
                            d.push(a), (s = a);
                    ...
                    for (i = 0;
                        ...
                        u.apply &&
                        Ye(a) &&
                        ((t.result = u.apply(a, n)), !1 === t.result && t.preventDefault());
                    return (
                        (t.type = h),
                        o ||
            ...
            ajax: function(t, n) {
                    ...
                    E = {
                        ...
                        getResponseHeader: function(e) {
                            ...
                            if (u) {
                                if (!s)
                                    for (s = {};
                                        (t = Yt.exec(a));) s[t[1].toLowerCase()] = t[2];
                                t = s[e.toLowerCase()];
                            }
                ...
                0 == xe.active++ &&
                    ...
                    ((d = h.url.slice(i.length)),
                        ...
                        ((i += (Nt.test(i) ? "&" : "?") + h.data), delete h.data), !1 === h.cache &&
                        ((i = i.replace(Pt, "$1")),
                            (d = (Nt.test(i) ? "&" : "?") + "_=" + At++ + d)),
                        (h.url = i + d)),
                    h.ifModified &&
        ...
        xe.each(["get", "post"], function(e, t) {
            xe[t] = function(e, n, r, o) {
                return (
                    ...
                    xe.ajax(
                        xe.extend({ url: e, type: t, dataType: o, data: n, success: r },
    ...
    xe.ajaxSetup({
        ...
        (xe.parseHTML = function(e, t, n) {
            ...
            return (
                ...
                (ve.createHTMLDocument ?
                    (((r = (t =
                            ae.implementation.createHTMLDocument("")).createElement(
                            "base"
                        )).href = ae.location.href),
        ...
        xe.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (
                        var e = this.offsetParent; e && "static" === xe.css(e, "position");
        ...
        xe.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" },
            function(e, t) {
                var n = "pageYOffset" === t;
                xe.fn[e] = function(r) {
                    return Re(
        ...
        xe.each({ Height: "height", Width: "width" }, function(e, t) {
            xe.each({ padding: "inner" + e, content: t, "": "outer" + e },
                function(n, r) {
...
(function(e, t) {
    ...
    function i(e) {
        ...
        for (
            var n = o(10) ? document.body : null, r = e.offsetParent || null; r === n && e.nextElementSibling;
    ...
    function n(n) {
        ...
        if (
            (O &&
                ...
                1 === n.deltaMode && ((a *= 40), (l *= 40)), !L.touchpadSupport &&
                (function(e) {
                    if (e)
                        return (
                            j.length || (j = [e, e, e]),
    ...
    var E = function(e, t, n, r, o) {
        ...
        C = function(e) {
            ...
            t.contains(e.scrollbarXRail) ||
                ...
                (i(t, y.element.rail("y")).forEach(function(e) {
                    ...
                    t.appendChild(e.scrollbarYRail)), !e.settings.suppressScrollX &&
        ...
        L = {
            ...
            wheel: function(t) {
                function n(e, n) {
                    ...
                    return (!(Math.abs(n) > Math.abs(e) ? o || i : s || l) ||
        ...
        k = function(r, o) {
            ...
            isNaN(this.scrollbarYRight) ?
                ...
                (this.reach = {
                    x: r.scrollLeft <= 0 ?
                        "start" : r.scrollLeft >= this.contentWidth - this.containerWidth ?
                        "end" : null,
                    y: r.scrollTop <= 0 ?
                        "start" : r.scrollTop >= this.contentHeight - this.containerHeight ?
                        "end" : null,
                }),
                (this.isAlive = !0),
